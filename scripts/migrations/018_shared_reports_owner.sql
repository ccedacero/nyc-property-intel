-- Migration 018: shared_reports.owner_token_hash — tie each saved report to
...
-- (pre-018) simply have no owner and stay out of every "mine" list. Mirrored
...
COMMENT ON COLUMN shared_reports.owner_token_hash IS
    'SHA-256 token_hash of the authenticated creator (NULL for anonymous reports). Drives the private "Your Reports" history at /api/reports/mine. See migration 018.';
