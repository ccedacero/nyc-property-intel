...
PAGES = [
    ...
    ("/propertyshark-alternative", "propertyshark-alternative.html", "monthly", "0.8"),
    ("/nyc-property-lien-search", "nyc-property-lien-search.html", "monthly", "0.9"),
    ("/nyc-tax-lien-sale-list", "nyc-tax-lien-sale-list.html", "monthly", "0.8"),
