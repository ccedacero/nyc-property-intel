...
class Settings(BaseSettings):
    ...
    # Returning-user sign-in email ("Your sign-in link") — falls back to the
    # activation template when unset. LOOPS_SIGNIN_TRANSACTIONAL_ID.
    loops_signin_transactional_id: str = ""
